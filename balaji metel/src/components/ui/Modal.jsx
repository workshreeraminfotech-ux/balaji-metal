    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        ...
        <motion.div
          ...
          className={cn(
            "relative w-full rounded-3xl bg-white border border-slate-200 shadow-2xl flex flex-col max-h-[90vh] text-slate-900",
            sizes[size]
          )}
        >
          <div className="flex items-center justify-between border-b border-slate-100 p-5 shrink-0">
            <h3 className="text-xl font-heading font-black text-slate-900">{title}</h3>
            <button
              onClick={onClose}
